...
stimulusContrasts       = [0.0187];%[0.22,0.46,0.92];%[.014, 0.028, 0.055, 0.11, 0.22];%[0.028, 0.055, 0.11, 0.22, 0.46];%
stimulusCenter          = [5,-5]; % [x,y] in degrees
spatialFreq             = 1; % cycle per degree
speed                   = 2; % degree per second
CRTmonitor              = true;
numTrials               = 50;%40;% % trials per condition
...
Result.allResponse = allResponse;
